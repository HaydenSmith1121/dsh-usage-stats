window.__ModuleLoader__.load({ id: "dsh-usage-stats", factory: (require) => { var module = { exports: {} }; var exports = module.exports;
"use strict";
...
function dayKeyBefore(time, days) {
  const date = new Date(time);
...
function cellInRange(cell, range, now) {
...
function sumRange(cells, range, now) {
